...
This paper uses both initial submission ($p$ hacking) and published ($p$ hacking and publication bias) versions.  
...
1. Tests of $p$ hacking: Test restriction on curvature, levels, continuity of density of $p$ curve to detect $p$ hacking.  
